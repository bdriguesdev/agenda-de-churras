...
module.exports = {
    async getChurrasco(request, response) {
        try {
    ...
    async getAllChurrascos(request, response) {
        try {
    ...
    async createChurrasco(request, response) {
        try {
    ...
    async updateChurrasco(request, response) {
        try {
    ...
    async deleteChurrasco(request, response) {
        try {
            const { id } = request.params;
            const user = request.isAuthorized;
