...
const ResponsiveNavBar = props => {
    ...
    const handleClickMenu = () => {
        if(isMenuAnimationInProgress) return;

        setIsNavBarOpen(oldValue => !oldValue);
        ...
        if(!isNavBarOpen) {
            ...
            tl 
            .add({
                targets: '.responsive-nav #menuMiddleLine',
                duration: 150,
                scaleX: 0,
                easing: 'easeInOutBounce'
            })
            .add({
                targets: '.responsive-nav #menuFirstLine',
                translateY: 7,
                duration: 300,
                rotate: [
                    {
            ...
            .add({
                targets: '.responsive-nav #menuLastLine',
                translateY: -7,
                duration: 300,
                rotate: [
                    {
            ...
            .add({
                targets: '.responsive-nav .menu__container',
                duration: 300,
                translateX: [250, 0],
                easing: 'easeOutSine'
            })
            .add({
                targets: ".responsive-nav .nav__item",
                duration: 200,
                opacity: [0 , 1],
                translateX: [40, 0],
    ...
    return (
        <nav className="responsive-nav">
            <div onClick={handleClickMenu} className="menu__icon">
                <div id="menuFirstLine" className="icon__line"></div>
                <div id="menuMiddleLine" className="icon__line"></div>
                <div id="menuLastLine" className="icon__line"></div>
            </div>
                    ...
                    props.token?
                        ...
                        <ul className="nav__list">
                            ...
                            <li className="nav__item">
                                <Link to="/login">
                                    entrar
                                    <svg className="enter__icon" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
