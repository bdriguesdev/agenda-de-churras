...
const Churrascos = props => {
    ...
    const handleCardsEnterAnimation = () => {
        anime({
    ...
    const handleCardsExitAnimation = node => {
        anime({
            targets: node,
            opacity: 0,
            scale: 0.5,
                    ...
                    <TransitionGroup className="churrascos__list">
                        {
                            ...
                            [
                                props.churrascos.map(churrasco => {
                                    return (
                                        <Transition
                                            ...
                                            onExit={handleCardsExitAnimation}
                                            appear
                                        >   
                                            <ChurrascoCard 
                                                churrasco={churrasco} 
                                ...
                                props.token &&
                                <div 
                                    onLoad={fixCreateCardHeight}
                                    onClick={handleOpenCreateModal}
                                    key="create__card"
                                    onMouseEnter={handleGrillMouseEnterAnimation} 
                                    onMouseLeave={handleGrillMouseLeaveAnimation} 
                                    className="create__card churrasco__card__animation"
                                >
                                    <div className="card__icon__container churrasco__card__animation">
