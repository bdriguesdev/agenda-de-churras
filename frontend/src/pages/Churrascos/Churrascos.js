...
const Churrascos = () => {
    ...
    const grillMouseEnterAnimation = () => {
    ...
    const grillMouseLeaveAnimation = () => {
    ...
    return (
        <div className="churrascos">
            ...
            <div className="churrascos__list">
                ...
                <ChurrascoCard />
                <ChurrascoCard />
                <div onMouseEnter={grillMouseEnterAnimation} onMouseLeave={grillMouseLeaveAnimation} className="create__card">
